...
<style>
  ...
  .clarence-header-doctype { font-size: 7px; font-weight: 700; color: #7c3aed; text-transform: uppercase; letter-spacing: 0.5px; }
  .clarence-header-meta { font-size: 6.5px; color: #94a3b8; }
  .clarence-header-lock { font-size: 7px; color: #7c3aed; margin-top: 1px; }
</style>
...
<div class="clarence-header">
  ...
  <div class="clarence-header-right">
    ...
    <div class="clarence-header-lock">&#128274; Initiator Only</div>
  </div>
</div>
...
<!-- ================================================================== -->
<!-- CLARENCE PLAYBOOK COMPLIANCE FOOTER — APITemplate.io Settings Tab  -->
<!-- ================================================================== -->
