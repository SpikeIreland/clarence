...
interface CustomerRequirements {
  ...
  // Market Context & Leverage
  numberOfBidders: string
  marketPosition: string
  dealSize: string
  dealValue: string // ADDED specific value
  decisionTimeline: string
  incumbentStatus?: string // ADDED
  ...
  projectScope: string
  serviceCriticality?: string // ADDED for leverage
  
  // BATNA Assessment (ADDED SECTION)
  ...
  switchingCosts?: string // ADDED
  budgetFlexibility?: string // ADDED
  
  // Contract Positions (Simplified)
  contractPositions: {
    liabilityCap: number
    paymentTerms: number
    slaTarget: number
  ...
  // Priorities (with point allocation)
  priorities: {
    cost: number
    quality: number
    speed: number
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`border rounded-lg p-4 mb-6 ${
        priorityPoints >= 0 ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'
      }`}>
