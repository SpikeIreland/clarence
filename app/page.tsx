  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800">
      <div className="container mx-auto px-6 py-8">
        ...
        {/* Main Content - Center - UPDATED WITH JOHN'S CHANGES */}
        <div className="max-w-3xl mx-auto text-center">
          <div className="animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            ...
            <p className="text-base text-slate-300 leading-relaxed font-light max-w-2xl mx-auto">
              Clarence leads parties through an intuitive and structured<br />
              negotiation process, combining AI-powered insights with transparent<br />
              brokering of compromises to efficiently agree optimal contracts.
            </p>
          </div>
        </div>
